...
void init_help(){
    ...
    w_gotoxy_puts(Help, 2, 2, "j - stop ball");
    w_gotoxy_puts(Help, 2, 3, "k - kick ball");
    w_gotoxy_puts(Help, 2, 4, "j - carry ball");
 //   w_gotoxy_puts(Help, 2, 6, "blue_score:");
 //   w_gotoxy_puts(Help, 2, 8, "red_score:");
}
